    ...
    <div id="nsc--social-media-section" className={`${className} hide-while-still-loading`}>
         <div className="social-media-section clearfix">
            ...
            {link_Facebook ? (<Link className="social-icon" href={`${link_Facebook}`} data-umami-click={`facebook link`} target="_blank">
              <svg className="facebook diff-sibiu-valcea diff-hover" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            ...
            {link_Instagram ? (<Link className="social-icon" href={`${link_Instagram}`} data-umami-click={`instagram link`} target="_blank">
              <svg className="instagram diff-sibiu-valcea diff-hover" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
