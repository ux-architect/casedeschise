...
export default async function RootLayout({children}: {children: React.ReactNode}) {
  ...
  return (
    ...
    {process.env.NODE_ENV === 'production' && ( <Script async src="/scripts/umami-tracking.js" data-collect-url="https://umami-app-ux-studio-sibiu.fly.dev/api/collect" data-website-id="4d2bd780-148b-40ef-9f49-e6c83c1f480f" strategy="afterInteractive"/>)}
    </head>
