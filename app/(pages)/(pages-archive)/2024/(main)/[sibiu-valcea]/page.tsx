...
export default async function Main({ params}: {params: Promise<{"sibiu-valcea": string}>;}) {
  ...
  return (
    <main className={`${styles['page-container']} `} data-no-highlight-on-nav>
      ...
      {projects_section1.length > 0 && (<section className="swiper-section"><Swiper_Projects projects={projects_section1}/><div className="category-title">{title_s1}</div></section>)}
      {projects_section2.length > 0 && (<section className="swiper-section"><Swiper_Projects projects={projects_section2} odd={true}/><div className="category-title title-right">{title_s2}</div></section>)}
      
      <SeeMapSection page={city} className="w-100 clearfix float-left mt-10"/>

      {projects_section3.length > 0 && (<section className="swiper-section"><Swiper_Projects projects={projects_section3}/><div className="category-title">{title_s3}</div></section>)}
      {projects_section4.length > 0 && (<section className="swiper-section"><Swiper_Projects projects={projects_section4} odd={true}/><div className="category-title title-right">{title_s4}</div></section>)}
